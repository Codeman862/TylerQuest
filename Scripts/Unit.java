...
public abstract class Unit extends cosmeticSprite {
	...
	public int side = 2; // determines the faction, 0 for other, 1 for player, 2
							// for ai, 3 for possibly a 2nd ai
	...
	/*
	 * public long aquireTimer[]=new long[4];//0 is timer, 1 is timer end, 2 is
	 * current duration, 3 is base duration public long baseFireTimer[]=new
	 * long[4];//in between shoots delay public long reloadTimer[]=new
	 * long[4];//reloading timer
	 */
